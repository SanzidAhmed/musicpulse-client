    ...
    <>
      ...
      >
        ...
        <SwiperSlide>
          ...
          <img src="https://images.unsplash.com/photo-1503506584117-5ed92741077a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" className="w-full md:h-[800px]" />
        ...
        <SwiperSlide>
          <div id="slide1" className="carousel-item relative w-full">
          <img src="https://images.unsplash.com/photo-1512733596533-7b00ccf8ebaf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1632&q=80" className="w-full md:h-[800px]" />
          <div className="absolute  transform -translate-y-1/2 left-20 right-5 top-32">
        ...
        <SwiperSlide>
          <div id="slide1" className="carousel-item relative w-full">
          <img src="https://images.unsplash.com/photo-1621784166258-c6fdfff31879?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" className="w-full md:h-[800px]" />
          <div className="absolute  transform -translate-y-1/2 left-20 right-5 top-32">
        ...
        <SwiperSlide>
          <div id="slide1" className="carousel-item relative w-full">
          <img src="https://images.unsplash.com/photo-1610716632424-4d45990bcd48?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1026&q=80" className="w-full  md:h-[800px]" />
          <div className="absolute  transform -translate-y-1/2 left-20 right-5 top-32">
